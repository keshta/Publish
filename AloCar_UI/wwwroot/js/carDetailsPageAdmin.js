...
$("#carAccessoryId").change(function () {
    ...
    loadingPage();
    $.ajax({
        url: "/SubCarAccessory/GetSubCarAccessory",
        type: "POST",
...
function btnAddEditCar() {
    ...
    var carDetails = {
        ...
        carDetailsTypeId: parseInt(jQuery.trim($("#carDetailsTypeId").val())),
    };
    ...
    if (chkValidation == true) {
        ...
        loadingPage();
        $.ajax({
            url: "/CarDetailsAdmin/AddEditCarDetails",
            type: "POST",
            ...
            success: function (result) {
                if (result.success == true) {
                    window.location.href = "/CarDetailsAdmin/Index";
                }
                else {
                    removeLoadingPage();
...
function carValidation(car) {
    ...
    $("#lblErrorCarDetailsTypeId").css("display", "none");
    ...
    if ((String(car.carImportId) != "" && String(car.carImportId) != null && String(car.carImportId) != undefined) &&
        ...
        (String(car.carDetailsTypeId) != "" && String(car.carDetailsTypeId) != null && String(car.carDetailsTypeId) != undefined) &&
        ...
        if (String(car.carDetailsTypeId) != "" && String(car.carDetailsTypeId) != null && String(car.carDetailsTypeId) != undefined) {
            $("#lblErrorCarDetailsTypeId").css("display", "none");
        }
        else {
            $("#lblErrorCarDetailsTypeId").css("display", "block");
        }
